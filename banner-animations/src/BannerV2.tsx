      ...
      {rows.map((i) => {
        ...
        return (
          <React.Fragment key={i}>
            <Circle cx={lx(565) + 14} cy={yTop + 14} r={11} delay={delay} localFrame={localFrame} />
            <SkelBox
              x={lx(565) + 36}
              y={yTop + 6}
              w={140}
        ...
        return (
          <React.Fragment key={i}>
            ...
            <SkelBox
              ...
              shimmerPeriod={shimmerPeriod}
            />
            <Circle cx={x + CARD_W - 14} cy={y + 16} r={4} delay={delay + 2} localFrame={localFrame} />
            <SkelBox
              x={x + 10}
              y={y + 32}
              w={CARD_W - 20}
...
const SceneContent: React.FC<{
  ...
  const tabFromTime = Math.min(
    3,
    Math.floor(
      interpolate(localFrame, [30, 160], [0, 4], {
        extrapolateLeft: "clamp",
        extrapolateRight: "clamp",
      })
    )
